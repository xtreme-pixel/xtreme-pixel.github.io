...
<template>
  ...
  <UModal v-model:open="open" title="Falta poco para la apertura" :close="true" size="md" description="Estamos afinando detalles para brindarte la mejor experiencia. ¡Pronto estaremos en línea!">
    <template #footer>
